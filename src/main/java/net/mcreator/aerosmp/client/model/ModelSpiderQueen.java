package net.mcreator.aerosmp.client.model;
...
public class ModelSpiderQueen<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("aerosmp", "model_spider_queen"), "main");
