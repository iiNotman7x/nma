package net.mcreator.aerosmp.entity;
...
import net.mcreator.aerosmp.procedures.SpiderQueenOnInitialEntitySpawnProcedure;
import net.mcreator.aerosmp.procedures.SpiderQueenEntityIsHurtProcedure;
...
public class SpiderQueenEntity extends Monster {
	...
	public boolean hurt(DamageSource damagesource, float amount) {
		...
		SpiderQueenEntityIsHurtProcedure.execute(world, x, y, z, entity);
